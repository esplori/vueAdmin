    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <div class="filename">
            <div v-if="typeConfig.music.includes(scope.row.filename.split('.')[1])">
            ...
            <div v-else-if="typeConfig.image.includes(scope.row.filename.split('.')[1])">
              <img :src="sourceUrl + scope.row.filename" alt="" width="100px" height="80px">
            </div>
            <div v-else>
              <span>{{ scope.row.filename }}</span>
            </div>
